...
public class RecordComparator {
    ...
    public double compare(String[] tuple1, String[] tuple2) {
        ...
        for (AttrSimWeight attrSimWeight : attrSimWeights) {
            ...
            // Get the attribute values from both tuples
            String value1 = tuple1[attrIndex];
            String value2 = tuple2[attrIndex];
            
            // Calculate similarity for this attribute
            double attrSimilarity = simMeasure.calculate(value1, value2);
            
            // Add weighted similarity to the total
